...
Slack." or "Nothing to submit this week: <the one change that unblocks the best row>.">
...
```tin-listings-state
{"version": 1, "rows": {"<id>": {"presence": "absent", "picked_runs": 1}}}
```
````
