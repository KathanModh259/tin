...
PACKAGE = ROOT / "workflow_packages/listings.partner_marketplaces"
RESOURCES = PACKAGE / "skills/partner-marketplaces"
FIXTURES = ROOT / "tests/fixtures/partner_marketplaces"
CASES = ROOT / "workflow_evals/listings.partner_marketplaces/qualification.json"
